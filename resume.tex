...
\begin{itemize}
  ...
  \item 职责：
    \begin{itemize}
      \item 主导Discovery发现模块的性能优化，将模块在小规模场景发现完毕的时间从130us缩短到\textasciitilde40us，大规模场景下延迟从3\textasciitilde5s降低至300ms。同时利用tokio异步框架改进原有架构，避免潜在的持有锁过长带来的性能影响。
      \item 负责ROS2以及其他中间件的多语言协同开发维护，构建高可靠Rust/C++跨语言互操作框架，驱动系统级性能优化与架构演进
